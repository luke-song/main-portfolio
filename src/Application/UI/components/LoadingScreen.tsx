        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            <p>Released: 01/10/2004</p>
                            <p>HHBIOS (C)2000 Luke Song Inc.,</p>
                        </div>
                    </div>
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p>Luke Song Portfolio Showcase 2024</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
                    ...
                    <div style={styles.startPopup}>
                        ...
                        <p>
                            ...
                            <a
                                style={styles.link}
                                href={
                                    'https://github.com/luke-song/portfolio-website/'
                                }
                            >
                                bug in firefox
                            </a>
